...
export function ReservationForm({
  ...
  const [selectedRoomId, setSelectedRoomId] = useState<string>(initialSelectedRoomId || "");
  ...
  // Update selectedRoomId when prop changes or dialog opens
  useEffect(() => {
    if (open && initialSelectedRoomId) {
      ...
      <DialogContent className="w-[95vw] sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!selectedRoomId || !selectedDate || !startHour || !endHour || !startTime || !endTime || loading}
          >
